...
left.addListener("publishPin", "python", "publishPin")
...
def publishPin(pin):
  ...
  if (pin.pin == 55):
    pin1 = pin
    global rightfast
    rightfast = pin1.value
    if (rightfast <= rightstedy ):
      global rightfast
      rightfast = rightstedy
    global rightstedy
