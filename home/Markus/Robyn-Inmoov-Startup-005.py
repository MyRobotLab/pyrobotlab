...
webgui.startService()
wksr = Runtime.createAndStart("i01.ear", "i01.ear")
...
i01.setAutoDisable(True)

i01.head.rothead.disableDelayIfVelocity = 3000
i01.head.neck.disableDelayIfVelocity = 3000

i01.rightHand.thumb.setAutoDisable(True)
i01.rightHand.index.setAutoDisable(True)
i01.rightHand.majeure.setAutoDisable(True)
i01.rightHand.ringFinger.setAutoDisable(True)
i01.rightHand.pinky.setAutoDisable(True)
i01.rightHand.wrist.setAutoDisable(True)
...
def ElinSv(): 
    ...
    i01.mouth.speak(u"Nu anvÃ¯Â¿Â½nder jag en svensk rÃ¯Â¿Â½st")  
