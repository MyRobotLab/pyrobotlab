...
""" 
bicep = Runtime.getService("i01.rightArm.bicep")
bicep.detach()
bicep.setPin(12)
bicep.attach()
"""
...
def input(cmd):
    ...
    if (cmd == "2"):
      ...
      if x == 1:
        i01.mouth.speak("#SNEEZE01#") 
      if x == 2:
        i01.mouth.speak("#WHISTLE01#")
      if x == 3:
        i01.mouth.speak("#WHISTLE02#")  
      if x == 4:
        i01.mouth.speak("#BREATH03#")
      if x == 5:
        i01.mouth.speak("#CAR_HORN#")
      if x == 6:
        i01.mouth.speak("#SNEEZE02#")
      if x == 7:
        i01.mouth.speak("#COUGH01#")
      if x == 8:
        i01.mouth.speak("#COUGH02#")
      if x == 9:
        i01.mouth.speak("#LAUGH01#") 
      if x == 10:
        i01.mouth.speak("#LAUGH02#")
      if x == 11:
        i01.mouth.speak("#LAUGH03#")
      if x == 12:
        i01.mouth.speak("#MMM01#") 
      if x == 13:
        i01.mouth.speak("#MMM02#")
      if x == 14:
        i01.mouth.speak("#MMM03#")
