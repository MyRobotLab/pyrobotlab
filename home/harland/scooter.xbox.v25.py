...
# feb 15 2015 running on mrl 1.0.107 and 1.0.99
# changed from uno board to mega board to make my life easier
# april  14 2015 pir sensor works to well always waking up
...
# reverse direction of head
#i01.head.rothead.map(0,180,170,10)
# reverse direction of neck
#i01.head.neck.map(0,180,170,50)
...
#  print pin.pin, pin.value, pin.type, pin.source,    
  if (pin.value == 0):
       uno.digitalReadPollingStop(readDigitalPin)     #turn off
       print pin.pin, pin.value, pin.type, pin.source,    
