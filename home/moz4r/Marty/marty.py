...
cuisseDroite.setRest(90)
genouDroite.setRest(90)
chevilleDroite.setRest(80)
cuisseGauche.setRest(97)
genouGauche.setRest(95)
chevilleGauche.setRest(90)
...
cuisseDroite.setVelocity(35)
genouDroite.setVelocity(35)
chevilleDroite.setVelocity(35)
cuisseGauche.setVelocity(35)
genouGauche.setVelocity(35)
chevilleGauche.setVelocity(35)
...
sleep(2)
cuisseGauche.moveTo(60)
sleep(2)
chevilleDroite.moveTo(110)
chevilleGauche.moveTo(110)
sleep(2)
cuisseGauche.moveTo(90)
sleep(2)
chevilleDroite.moveTo(70)
chevilleGauche.moveTo(70)
