...
i01.head.jaw.setVelocity(0)
i01.head.jaw.setMinMax(65,90)
#i01.head.jaw.map(0,90,65,90)
...
i01.torso.topStom.setVelocity(0)
i01.torso.midStom.setVelocity(0)
#i01.torso.lowStom.setVelocity(5)
i01.torso.topStom.setMinMax(0,180)
i01.torso.topStom.map(0,180,70,120)
i01.torso.midStom.setMinMax(0,180)
i01.torso.topStom.map(0,180,60,120)
#i01.torso.lowStom.setMinMax(0,180)
i01.torso.topStom.setRest(110)
#i01.torso.midStom.setRest(90)
#i01.torso.lowStom.setRest(90)
##############
i01.startLeftHand(leftPort)
# tweaking default settings of left hand
i01.leftHand.thumb.setVelocity(25)
i01.leftHand.index.setVelocity(25)
i01.leftHand.majeure.setVelocity(25)
i01.leftHand.ringFinger.setVelocity(25)
i01.leftHand.pinky.setVelocity(25)
i01.leftHand.wrist.setVelocity(25)
...
i01.leftArm.bicep.setVelocity(30)
i01.leftArm.rotate.setVelocity(30)
i01.leftArm.shoulder.setVelocity(30)
i01.leftArm.omoplate.setVelocity(30)
...
i01.rightHand.thumb.setVelocity(25)
i01.rightHand.index.setVelocity(25)
i01.rightHand.majeure.setVelocity(25)
i01.rightHand.ringFinger.setVelocity(25)
i01.rightHand.pinky.setVelocity(25)
i01.rightHand.wrist.setVelocity(25)
...
i01.rightArm.bicep.setVelocity(30)
i01.rightArm.rotate.setVelocity(30)
i01.rightArm.shoulder.setVelocity(30)
i01.rightArm.omoplate.setVelocity(30)
...
ear.addCommand("attach sensor", "i01", "startPIR")
ear.addCommand("disconnect sensor", "i01", "stopPIR")
...
ear.addCommand("left clothes", "python", "releaseleftclothes")
ear.addCommand("take off your right clothes", "python", "rightclothes")
ear.addCommand("gestures for london one", "python", "brooke")
ear.addCommand("gestures for london two", "python", "brooke2")
ear.addCommand("gestures for london three", "python", "gestureforlondon3")
ear.addCommand("gestures for london four", "python", "gestureforlondon4")
#ear.addCommand("watch out", "python", "watch out")


#Direct verbal commands("yes | no | very good, thank you | it's okay | no thanks | no thank you | sorry | how do you do | hello | finnish hello | i know | yes let's play again | i have rock | i have paper | i have scissors | look at the people | pause | can i have your attention | good morning | very good | italian hello | alessandro | bye bye | i love you | thanks | thank you | shake hand| what about star wars | where are you from | nice | what is the weather | are you hungry | do you speak hindi | go forward | go backwards | watch out and stop | walk gesture | walking off | to the left | to the right | go straight | can you give me the time | I know but show it anyway | sorry I forgot | show your back | not true it's finished | it's an object | you did great | hi there | are you okay | don't worry")
ear.startListening()
...
def signature():
    ...
    i01.moveHand("left",2,2,2,2,2,90)
    i01.moveHand("right",180,180,180,179,180,155)
    sleep(2)
    i01.moveHead(0,83,90,90,74)
    i01.moveArm("left",67,65,64,10)
    ...
    i01.moveHead(0,83,90,90,74)
    i01.moveArm("left",67,65,64,10)
    i01.moveArm("right",79,60,72,24)
    i01.moveHand("left",2,2,2,2,2,90)
    i01.moveHand("right",180,180,180,179,180,155)
    sleep(2)
    i01.moveHead(0,83,90,90,74)
    i01.moveArm("left",74,61,64,10)
    i01.moveArm("right",79,65,72,24)
    i01.moveHand("left",2,2,2,2,2,90)
    i01.moveHand("right",180,180,180,179,180,155)
    sleep(2)
    i01.moveHead(0,83,90,90,74)
    i01.moveArm("left",74,60,64,10)
    i01.moveArm("right",78,65,72,24)
    i01.moveHand("left",2,2,2,2,2,90)
    i01.moveHand("right",180,180,180,179,180,155)
    sleep(2)
    i01.moveHead(0,83,90,90,74)
    i01.moveArm("left",75,61,69,10)
    i01.moveArm("right",78,65,72,24)
    i01.moveHand("left",2,2,2,2,2,76)
    i01.moveHand("right",180,180,180,179,180,155)
    sleep(2)
    i01.moveHead(0,83,90,90,74)
    i01.moveArm("left",75,61,69,10)
