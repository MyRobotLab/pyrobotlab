...
global right_thumb_Psi_min
right_thumb_Psi_min=0
global right_index_Psi_min
right_index_Psi_min=0
global right_majeure_Psi_min
right_majeure_Psi_min=0
global right_ringFinger_Psi_min
right_ringFinger_Psi_min=0
global right_pinky_Psi_min
right_pinky_Psi_min=0
global right_extra_Psi_min
right_extra_Psi_min=0

global left_thumb_Psi_min
left_thumb_Psi_min=0
global left_index_Psi_min
left_index_Psi_min=0
global left_majeure_Psi_min
left_majeure_Psi_min=0
global left_ringFinger_Psi_min
left_ringFinger_Psi_min=0
global left_pinky_Psi_min
left_pinky_Psi_min=0
global left_extra_Psi_min
left_extra_Psi_min=0
  ...
  try:
    ...
    def publishRightSensor(pinsRight):
          ...
          for pin in range(0, len(pinsRight)):
            rightPsiMin=(pinsRight[pin].value)
            if pinsRight[pin].address==(right_thumbPin):
              if pinsRight[pin].value<=(right_thumb_Psi_min) and pinsRight[pin].value<((right_thumb_Psi_min)+(right_thumb_Psi_low)):rightThumbPressure = 0 
              if pinsRight[pin].value>=((right_thumb_Psi_min)+(right_thumb_Psi_low))and pinsRight[pin].value<((right_thumb_Psi_min)+(right_thumb_Psi_mid)):
                if rightThumbPressure == 1:
                  i01.rightHand.thumb.stop()
                  i01.rightHand.thumb.disable()
              if pinsRight[pin].value>=((right_thumb_Psi_min)+(right_thumb_Psi_mid))and pinsRight[pin].value<((right_thumb_Psi_min)+(right_thumb_Psi_max)):
                if rightThumbPressure == 2:
                  i01.rightHand.thumb.stop()
                  i01.rightHand.thumb.disable()
              if pinsRight[pin].value>=((right_thumb_Psi_min)+(right_thumb_Psi_max)):
            ...
            if pinsRight[pin].address==(right_indexPin):
              if pinsRight[pin].value<=(right_index_Psi_min) and pinsRight[pin].value<((right_index_Psi_min)+(right_index_Psi_low)):rightIndexPressure = 0
              ...
              if pinsRight[pin].value>=((right_index_Psi_min)+(right_index_Psi_mid))and pinsRight[pin].value<((right_index_Psi_min)+(right_index_Psi_max)):
                if rightIndexPressure == 2:
                  i01.rightHand.index.stop()
                  i01.rightHand.index.disable()
              if pinsRight[pin].value>=((right_index_Psi_min)+(right_index_Psi_max)):
            ...
            if pinsRight[pin].address==(right_majeurePin):
              if pinsRight[pin].value<=(right_majeure_Psi_min) and pinsRight[pin].value<((right_majeure_Psi_min)+(right_majeure_Psi_low)):rightMajeurePressure = 0
              if pinsRight[pin].value>=((right_majeure_Psi_min)+(right_majeure_Psi_low))and pinsRight[pin].value<((right_majeure_Psi_min)+(right_majeure_Psi_mid)):
                if rightMajeurePressure == 1:
                  i01.rightHand.majeure.stop()
                  i01.rightHand.majeure.disable()                  
              if pinsRight[pin].value>=((right_majeure_Psi_min)+(right_majeure_Psi_mid))and pinsRight[pin].value<((right_majeure_Psi_min)+(right_majeure_Psi_max)):
                if rightMajeurePressure == 2:
                  i01.rightHand.majeure.stop()
                  i01.rightHand.majeure.disable()
              if pinsRight[pin].value>=((right_majeure_Psi_min)+(right_majeure_Psi_max)):
            ...
            if pinsRight[pin].address==(right_ringFingerPin):
              if pinsRight[pin].value<=(right_ringFinger_Psi_min) and pinsRight[pin].value<((right_ringFinger_Psi_min)+(right_ringFinger_Psi_low)):rightRingFingerPressure = 0
              if pinsRight[pin].value>=((right_ringFinger_Psi_min)+(right_ringFinger_Psi_low))and pinsRight[pin].value<((right_ringFinger_Psi_min)+(right_ringFinger_Psi_mid)):
                if rightRingFingerPressure == 1:
                  i01.rightHand.ringFinger.stop()
                  i01.rightHand.ringFinger.disable()
              if pinsRight[pin].value>=((right_ringFinger_Psi_min)+(right_ringFinger_Psi_mid))and pinsRight[pin].value<((right_ringFinger_Psi_min)+(right_ringFinger_Psi_max)):
                if rightRingFingerPressure == 2:
                  i01.rightHand.ringFinger.stop()
                  i01.rightHand.ringFinger.disable()
              if pinsRight[pin].value>=((right_ringFinger_Psi_min)+(right_ringFinger_Psi_max)):
            ...
            if pinsRight[pin].address==(right_pinkyPin):
              if pinsRight[pin].value<=(right_pinky_Psi_min) and pinsRight[pin].value<((right_pinky_Psi_min)+(right_pinky_Psi_low)):rightPinkyPressure = 0
              if pinsRight[pin].value>=((right_pinky_Psi_min)+(right_pinky_Psi_low))and pinsRight[pin].value<((right_pinky_Psi_min)+(right_pinky_Psi_mid)):
                if rightPinkyPressure == 1:
                  i01.rightHand.pinky.stop()
                  i01.rightHand.pinky.disable()
              if pinsRight[pin].value>=((right_pinky_Psi_min)+(right_pinky_Psi_mid))and pinsRight[pin].value<((right_pinky_Psi_min)+(right_pinky_Psi_max)):
                if rightPinkyPressure == 2:
                  i01.rightHand.pinky.stop()
                  i01.rightHand.pinky.disable()
              if pinsRight[pin].value>=((right_pinky_Psi_min)+(right_pinky_Psi_max)):
            ...
            if pinsRight[pin].address==(right_extraPin):
              if pinsRight[pin].value<=(right_extra_Psi_min) and pinsRight[pin].value<((right_extra_Psi_min)+(right_extra_Psi_low)):rightExtraPressure = 0
              if pinsRight[pin].value>=((right_extra_Psi_min)+(right_extra_Psi_low))and pinsRight[pin].value<((right_extra_Psi_min)+(right_extra_Psi_mid)):rightExtraPressure = 1
              if pinsRight[pin].value>=((right_extra_Psi_min)+(right_extra_Psi_mid))and pinsRight[pin].value<((right_extra_Psi_min)+(right_extra_Psi_max)):rightExtraPressure = 2
              if pinsRight[pin].value>=((right_extra_Psi_min)+(right_extra_Psi_max)):rightExtraPressure = 3
    ...
    def RightSensorCalibrate():
        ...
        #sleep(0.1)
        #right_extra_Psi_min= (unicode(rightPsiMin, 'utf-8'))
        #print "right_extra_Psi_min:",right_extra_Psi_min
        print "Autocalibration right hand sensor done!"
  ...
  try:
    ...
    def publishLeftSensor(pinsLeft):
          ...
          for pin in range(0, len(pinsLeft)):
            leftPsiMin=(pinsLeft[pin].value)
            if pinsLeft[pin].address==(left_thumbPin):
              if pinsLeft[pin].value<=(left_thumb_Psi_min) and pinsLeft[pin].value<((left_thumb_Psi_min)+(left_thumb_Psi_low)):leftThumbPressure = 0 
              if pinsLeft[pin].value>=((left_thumb_Psi_min)+(left_thumb_Psi_low))and pinsLeft[pin].value<((left_thumb_Psi_min)+(left_thumb_Psi_mid)):
                if leftThumbPressure == 1:
                  i01.leftHand.thumb.stop()
                  i01.leftHand.thumb.disable()
              if pinsLeft[pin].value>=((left_thumb_Psi_min)+(left_thumb_Psi_mid))and pinsLeft[pin].value<((left_thumb_Psi_min)+(left_thumb_Psi_max)):
                if leftThumbPressure == 2:
                  i01.leftHand.thumb.stop()
                  i01.leftHand.thumb.disable()
              if pinsLeft[pin].value>=((left_thumb_Psi_min)+(left_thumb_Psi_max)):
            ...
            if pinsLeft[pin].address==(left_indexPin):
              if pinsLeft[pin].value<=(left_index_Psi_min) and pinsLeft[pin].value<((left_index_Psi_min)+(left_index_Psi_low)):leftIndexPressure = 0
              if pinsLeft[pin].value>=((left_index_Psi_min)+(left_index_Psi_low))and pinsLeft[pin].value<((left_index_Psi_min)+(left_index_Psi_mid)):
                if leftIndexPressure == 1:
                  i01.leftHand.index.stop()
                  i01.leftHand.index.disable()
              if pinsLeft[pin].value>=((left_index_Psi_min)+(left_index_Psi_mid))and pinsLeft[pin].value<((left_index_Psi_min)+(left_index_Psi_max)):
                if leftIndexPressure == 2:
                  i01.leftHand.index.stop()
                  i01.leftHand.index.disable()
              if pinsLeft[pin].value>=((left_index_Psi_min)+(left_index_Psi_max)):
            ...
            if pinsLeft[pin].address==(left_majeurePin):
              if pinsLeft[pin].value<=(left_majeure_Psi_min) and pinsLeft[pin].value<((left_majeure_Psi_min)+(left_majeure_Psi_low)):leftMajeurePressure = 0
              if pinsLeft[pin].value>=((left_majeure_Psi_min)+(left_majeure_Psi_low))and pinsLeft[pin].value<((left_majeure_Psi_min)+(left_majeure_Psi_mid)):
                if leftMajeurePressure == 1:
                  i01.leftHand.majeure.stop()
                  i01.leftHand.majeure.disable()
              if pinsLeft[pin].value>=((left_majeure_Psi_min)+(left_majeure_Psi_mid))and pinsLeft[pin].value<((left_majeure_Psi_min)+(left_majeure_Psi_max)):
                if leftMajeurePressure == 2:
                  i01.leftHand.majeure.stop()
                  i01.leftHand.majeure.disable()
              if pinsLeft[pin].value>=((left_majeure_Psi_min)+(left_majeure_Psi_max)):
            ...
            if pinsLeft[pin].address==(left_ringFingerPin):
              ...
              if pinsLeft[pin].value>=((left_ringFinger_Psi_min)+(left_ringFinger_Psi_low))and pinsLeft[pin].value<((left_ringFinger_Psi_min)+(left_ringFinger_Psi_mid)):
                if leftRingFingerPressure == 1:
                  i01.leftHand.ringFinger.stop()
                  i01.leftHand.ringFinger.disable()
              if pinsLeft[pin].value>=((left_ringFinger_Psi_min)+(left_ringFinger_Psi_mid))and pinsLeft[pin].value<((left_ringFinger_Psi_min)+(left_ringFinger_Psi_max)):
                if leftRingFingerPressure == 2:
                  i01.leftHand.ringFinger.stop()
                  i01.leftHand.ringFinger.disable()
              if pinsLeft[pin].value>=((left_ringFinger_Psi_min)+(left_ringFinger_Psi_max)):
            ...
            if pinsLeft[pin].address==(left_pinkyPin):
              ...
              if pinsLeft[pin].value>=((left_pinky_Psi_min)+(left_pinky_Psi_low))and pinsLeft[pin].value<((left_pinky_Psi_min)+(left_pinky_Psi_mid)):
                if leftPinkyPressure == 1:
                  i01.leftHand.pinky.stop()
                  i01.leftHand.pinky.disable()
              if pinsLeft[pin].value>=((left_pinky_Psi_min)+(left_pinky_Psi_mid))and pinsLeft[pin].value<((left_pinky_Psi_min)+(left_pinky_Psi_max)):
                if leftPinkyPressure == 2:
                  i01.leftHand.pinky.stop()
                  i01.leftHand.pinky.disable()
              if pinsLeft[pin].value>=((left_pinky_Psi_min)+(left_pinky_Psi_max)):
            ...
            if pinsLeft[pin].address==(left_extraPin):
              ...
              if pinsLeft[pin].value>=((left_extra_Psi_min)+(left_extra_Psi_low))and pinsLeft[pin].value<((left_extra_Psi_min)+(left_extra_Psi_mid)):leftExtraPressure = 1
              if pinsLeft[pin].value>=((left_extra_Psi_min)+(left_extra_Psi_mid))and pinsLeft[pin].value<((left_extra_Psi_min)+(left_extra_Psi_max)):leftExtraPressure = 2
              if pinsLeft[pin].value>=((left_extra_Psi_min)+(left_extra_Psi_max)):leftExtraPressure = 3
    ...
    def LeftSensorCalibrate():
        ...
        #sleep(0.1)
        #left_extra_Psi_min= (unicode(leftPsiMin, 'utf-8'))
        #print "left_extra_Psi_min:",left_extra_Psi_min
        print "Autocalibration left hand sensor done!"
...
def fingerSensorCalib():
    if rightHandSensorActivated:
      RightSensorCalibrate()  
    if leftHandSensorActivated:
      LeftSensorCalibrate()
    else:
      pass      
